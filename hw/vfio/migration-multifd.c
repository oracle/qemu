                                               ...
                                               Error **errp)
{
    ...
    if (vfio_save_device_config_state(f, vbasedev)) {
        error_setg(errp, "%s: vfio_save_device_config_state() failed",
                   vbasedev->name);
        return false;
    }
                                          ...
                                          Error **errp)
{
    ...
    if (vfio_migration_set_state(vbasedev, VFIO_DEVICE_STATE_STOP_COPY,
        ...
        error_setg(errp, "%s: vfio_migration_set_state() failed",
                   vbasedev->name);
        goto thread_exit;
    }
