...
static void vfio_user_instance_finalize(Object *obj)
{
    ...
    if (vdev->msix_regions != NULL) {
        g_free(vdev->msix_regions);
        vdev->msix_regions = NULL;
    }
