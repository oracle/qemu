                               ...
                               Error **errp)
{
    ...
    if (cap_list[MIGRATION_CAPABILITY_SWITCHOVER_ACK]) {
...
bool migrate_switchover_ack(void)
{
    ...
    return s->enabled_capabilities[MIGRATION_CAPABILITY_SWITCHOVER_ACK];
}
                                      ...
                                      int64_t current_time)
{
    ...
    s->threshold_size = expected_bw_per_ms * s->parameters.downtime_limit;
...
static void *migration_thread(void *opaque)
{
    ...
    ret = qemu_savevm_state_setup(s->to_dst_file, &local_error);
...
static Property migration_properties[] = {
    ...
    DEFINE_PROP_BOOL("multifd-clean-tls-termination", MigrationState,
                     multifd_clean_tls_termination, false),
