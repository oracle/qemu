...
Starting from upstream QEMU version 10.0 there's a possibility to transfer VFIO
device _STOP_COPY state via multifd channels. This helps reduce downtime -
especially with multiple VFIO devices or with devices having a large migration
state.
